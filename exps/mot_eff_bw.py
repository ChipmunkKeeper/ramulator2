...
# archs = ["DDR3", "DDR4", "DDR5", "LPDDR5", "GDDR6"]
archs = ["HB"]
arch_configs = {
    "HB": {"impl": "DDR4", "org_preset": "HB_2MB_x64", "timing_preset": "HB_500",},
...
for arch in archs:
    ...
    if arch == "HB":
        config["Frontend"]["path"] = os.path.join(config_base_dir, "traces/streaming_read_step_8B.trace")
    else:
        config["Frontend"]["path"] = os.path.join(config_base_dir, "traces/streaming_read_step_2B.trace")
